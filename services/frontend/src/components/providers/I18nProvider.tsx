...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    'dashboard.videos.description': 'View and manage your processed videos',
  ...
  pl: {
    ...
    'dashboard.videos.title': 'Twoje wideo',
    'dashboard.videos.description': 'Przeglądaj i zarządzaj swoimi przetworzonymi filmami',
  ...
  de: {
    ...
    'dashboard.videos.description': 'Betrachte und verwalte deine verarbeiteten Videos',
